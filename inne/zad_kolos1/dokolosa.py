...
print(string[:-2])
# wyświetla litery od początku do przed ostatniej czyli 'comput'
...
# wyświetla listę kluczy czyli ['pork', 'beef', 'chicken']
print(dictionary.values())
# wyświetla listę wartości czyli [25.3, 33.8, 22.7]
print(dictionary.items())
# wyświetla listę par klucz-wartość czyli
